...
prep_mean_data = np.zeros((300,170494))

for subject_num, subject in enumerate(analysis_info['subject_list']):
    print(subject,subject_num)
    file_in_name = opj(raw_shared_dir,subject,'tfMRI_RETBARS_Atlas_1.6mm_MSMAll_hp2000_clean_sg_psc.dtseries.nii')
    data_load = cifti.read(file_in_name)
    data = data_load[0]
...
file_out_name = opj(raw_shared_dir,'999999','tfMRI_RETBARS_Atlas_1.6mm_MSMAll_hp2000_clean_sg_psc.dtseries.nii')
