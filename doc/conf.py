...
# -*- coding: utf-8 -*-
#
# retino_HCP documentation build configuration file, created by
...
htmlhelp_basename = 'retino_HCPdoc'
...
latex_documents = [
  ('index', 'retino_HCP.tex', 'retino_HCP Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'retino_HCP', 'retino_HCP Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'retino_HCP', 'retino_HCP Documentation',
   'Ariel Rokem', 'retino_HCP', 'One line description of project.',
   'Miscellaneous'),
]
