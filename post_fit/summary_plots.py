...
if avg_subject:
    ...
    end_file_avg = ''
h5file = h5py.File(opj(base_dir,'pp_data',subject,fit_model,'h5','summary.h5'), "r")
...
exec('fig_bokeh_dir = opj(base_dir,"pp_data","{subject}",fit_model,"figs","prf")'.format(subject = subject))
