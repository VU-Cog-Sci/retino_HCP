...
description = "retino_HCP: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/retino_HCP/blob/master/README.md

License
=======
``retino_HCP`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/retino_HCP"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'retino_HCP': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
