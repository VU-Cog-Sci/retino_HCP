...
python post_fit/polar_prog.py sub-01 gauss_sg 1
python post_fit/polar_prog.py sub-02 gauss_sg 1
-----------------------------------------------------------------------------------------
"""
...
for type_data in ["gridfit","fit"]:
    ...
    if save_svg == 1:
        svg_folder = opj(base_dir,"pp_data",subject,fit_model,"figs",type_data,"svg","neg","LR","ANG_LR_neg_pRFpol")
    ...
    # create folder
    fig_bokeh_dir_neg_LR = opj(base_dir,"pp_data",subject,fit_model,"figs",type_data,"prf","neg","LR")
